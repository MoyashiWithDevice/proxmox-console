...
export type IconName =
  ...
  | 'layers' | 'refresh' | 'plus' | 'logOut' | 'package'
  | 'arrowLeft' | 'arrowRight' | 'terminal' | 'download' | 'trash'
  | 'alertTriangle' | 'alertCircle' | 'check';
...
export function Icon({ name, width = 16, height = 16, color = 'currentColor' }: IconProps) {
  return (
    <svg
      width={width}
      height={height}
